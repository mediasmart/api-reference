# mediasmart OpenAPI Specification
[![Build Status](https://travis-ci.org/mediasmart/api-reference.svg?branch=master)](https://travis-ci.org/mediasmart/api-reference)
...
6. If you did everything correct, https://mediasmart.github.io/api-reference/ will lead to your new docs
...
- Documentation(ReDoc): https://mediasmart.github.io/api-reference/
- SwaggerUI: https://mediasmart.github.io/api-reference/swagger-ui/
- Look full spec:
    + JSON https://mediasmart.github.io/api-reference/swagger.json
    + YAML https://mediasmart.github.io/api-reference/swagger.yaml
- Preview spec version for branch `[branch]`: https://mediasmart.github.io/api-reference/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://mediasmart.github.io/api-reference/ with url from the message: `Server started <url>`
